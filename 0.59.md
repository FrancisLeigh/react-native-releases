...
React Hooks are here, which let you reuse stateful logic across components. This addition has a lot of buzz about it; take a look at some of the wonderful resources below to learn more:
...
We need the community to let us know how it works before we turn it on by default. When you upgrade to 0.59, there will be a new `metro.config.js` file; flip the `inlineRequires` option and give us [your feedback](https://twitter.com/hashtag/inline-requires)! Read more about inline requires [in the performance docs](https://facebook.github.io/react-native/docs/0.56/performance#inline-requires) to see it work and benchmark your app's performance improvement.
