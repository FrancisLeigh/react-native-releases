...
Welcome to the February 2019 release of React Native! This release includes a number of highly anticipated changes, and we hope you enjoy them. Some of the key highlights include:

- [React Hooks](https://reactjs.org/docs/hooks-intro.html) are here, which powers [functional reuse](https://reactjs.org/docs/hooks-custom.html) [across components](https://medium.com/@dan_abramov/making-sense-of-react-hooks-fdbde8803889)
- `react-native` CLI now executes commands in 1/10th the time with prettier log formatting and more improvements are coming; thanks to the [dedicated group of maintainers](https://blog.callstack.io/the-react-native-cli-has-a-new-home-79b63838f0e6) working in a new repository
- Many components are now moving to separate libraries as part of our [focusing](https://github.com/facebook/react-native/issues/23313) -- heed these deprecation warnings today to simplify upgrading in the future
- Android support for 64 bit execution is here via an improved JavaScript Core
- Development on Android should be easier overall thanks to a number of breaking changes

These exciting changes are only possible thanks to an incredible 644 commits by 88 contributors. Contributions come forms besides commits as well, so *thank you* to those who help maintain issues, foster communities, and teach new people about React Native.

Without further adieu, here are the changes:
...
- React sync for revisions 6bf5e85...aa94237 (#23320) ([ccefc70](https://github.com/facebook/react-native/commit/ccefc70) by [@cpojer](https://github.com/cpojer))
...
- React sync for revisions aa94237...f24a0da ([2af13b4](https://github.com/facebook/react-native/commit/2af13b4) by [@hramos](https://github.com/hramos))
